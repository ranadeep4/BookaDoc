...
function Appointment() {
  ...
  //   let today = new Date();
  //   let allSlots = []; // Accumulate all slots here
  ...
  //     // Add the day's slots to allSlots
  //     allSlots.push(timeSlots);
  //   }
  
  //   // Update the state with all accumulated slots
  ...
  return docInfo && (
    <div>
      ...
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        ...
        <button onClick={bookAppointment} className='bg-primary text-white text-sm  px-14 py-3 rounded-full my-6'>Book an appointment</button>
      </div>
