...
function AddDoctor() {
  ...
  return (
    <form onSubmit={submitHandler} className="m-5 w-full" action="">
      ...
      <div className="bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
        ...
        <button type="submit" className="bg-primary px-10 py-3 mt-4 text-secondary rounded-full">Add doctor</button>
      </div>
    </form>
  );
}
